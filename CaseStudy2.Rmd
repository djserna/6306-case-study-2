...
#Number obs in each category
table(HasSubstanceAbuse=MHSubstanceAbuse$HasSubstanceAbuse, DiscussWithBoss=MHSubstanceAbuse$NUM_DiscussMHWithBoss)

#Proportion of those with substance abuset that would discuss the issue with their supervisor
prop.table(table(HasSubstanceAbuse=MHSubstanceAbuse$HasSubstanceAbuse, DiscussWithBoss=MHSubstanceAbuse$NUM_DiscussMHWithBoss), margin = 1)*100

#Chi square test of association
chisq.test(table(HasSubstanceAbuse=MHSubstanceAbuse$HasSubstanceAbuse, DiscussWithBoss=MHSubstanceAbuse$NUM_DiscussMHWithBoss))

fit1 <- glm(NUM_DiscussMHWithBoss ~ HasSubstanceAbuse, data=MHSubstanceAbuse, family = binomial )
summary(fit1)
```

2. Do workers with substance abuse disorders report that their anonymity was not protected?

3. Do workers with substance abuse disorder report that they hear of negative consequences for co-workers with mental health issues?

4. Do workers with substance abuse disorder report that they have experience with unsuportive response?
